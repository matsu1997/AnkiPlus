  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(backgroundColor: Colors.transparent,
          title: Text("review",style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 30),),
          ...
          body:SingleChildScrollView(
            child:Column(children: [
             // Container(margin: EdgeInsets.only(top: 0),color: Colors.transparent, width: double.infinity, alignment: Alignment.center, child: Text("review", style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 40), textAlign: TextAlign.center,)),
              Container(margin: EdgeInsets.only(top: 0),color: Colors.transparent, width: double.infinity, alignment: Alignment.center, child: Text("1度で答えられなかった問題", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 10), textAlign: TextAlign.center,)),
                  ...
                  child: GridView.count(padding: EdgeInsets.all(20.0),
                      ...
                      children: List.generate(item.length, (index) {
                        return GestureDetector(
                            onTap: () { var connectivityResult =  (Connectivity().checkConnectivity());
                            if (connectivityResult == ConnectivityResult.none) {
                              ...
                              if(itemBool[index] != 0){Navigator.of(context).push(MaterialPageRoute(builder: (context) => V2Q(item[index],itemAll[index],item1[0]["All"])),).then((value) => first());}}},
