  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.white,
        appBar: AppBar(
          ...
          title: Text(widget.name,style: TextStyle(fontWeight: FontWeight.bold,color:Colors.blueGrey[900],fontSize: 15),),
                  ...
                  children: List.generate(item.length, (index) {
                    return GestureDetector(
                        ...
                        child: Container(alignment: Alignment.center, decoration: BoxDecoration(color: Colors.grey[100], borderRadius: BorderRadius.circular(10),),// boxShadow: [new BoxShadow(color: Colors.grey, offset: new Offset(1.0, 1.0), blurRadius: 3.0,spreadRadius: 1)],),
                          ...
                          Expanded(child:Container(margin:EdgeInsets.only(top:5,bottom: 5,left:10,right: 5),child:Text(item[index],style: TextStyle(color: Colors.blueGrey[700],fontWeight: FontWeight.bold,fontSize: 15),),)),
                        ...
                        Container(margin:EdgeInsets.only(top:5,bottom: 5,right:5),alignment:Alignment.centerRight,child: Icon(Icons.star_border,color: Colors.orange,size: 20,),):
                          ...
                          Container(margin:EdgeInsets.only(top:5,bottom: 5,right:5),alignment:Alignment.centerRight,child: Icon(Icons.star_half,color: Colors.orange,size: 20),):
                        //10
